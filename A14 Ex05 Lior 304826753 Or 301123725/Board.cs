namespace A14_Ex05
{
     ...
     public class Board
     {
          private LogicBoardCell[,] m_GameBoard;          
          ...
          public Board(int i_RowSize, int i_ColSize)
          {
               m_RowSize = i_RowSize;
               m_ColSize = i_ColSize;               
               m_GameBoard = new LogicBoardCell[i_RowSize, i_ColSize];
          ...
          public void ResetBoard(int i_RowSize, int i_ColSize)
          {
               ...
               for (int row = 0; row < i_RowSize; row++)
               {
                    ...
                    {
                         m_GameBoard[row, col].CellType = eBoardCellTypes.Empty;
                    }
               }     
          }
          ...
          {
               return this.m_GameBoard[i_Row, i_Col].CellType;
          }

          public LogicBoardCell[,] GameBoard
          {
          ...
          {             
               return this.m_NumOfOccupiedCells == this.m_NumOfTotalCells;              
          }
